...
//thêm 2 dòng dưới là hiệu suất của app tăng vì nó dùng tối đa số thread có thể dùng trong máy. Nếu máy có 4 threads mà
//ta dùng nhiều hơn thì cx k nhanh hơn, nếu máy nhiều tác vụ nặng mà dùng hết số threads thì có thể cx k khá hơn, thg
//thì họ có server chuyên dụng cho vc này k chạy tác vụ cá nhân gì khác
// const os = require("os");
// process.env.UV_THREADPOOL_SIZE = os.cpus().length;//cách set giá trị biến môi trường

//dùng bcrypt để làm nặng tác vụ của server
...
//vói dòng máy quad core. VD dòng máy dual core là 2 core, mỗi core dùng được 2 thread là max 3 thread thì dòng
